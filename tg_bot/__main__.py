...
എന്നെ നോക്കി നടത്തുന്നത്  [PROFESSOR](tg://user?id={}) ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 

എന്നെ ഉപയോഗിക്കാൻ ആവിശ്യമായ commandകൾ അറിയാൻ /help കൊടുത്താൽ മതിയാകും..
വിവരങ്ങൾക്കായി /info  ഉപയോഗിക്കാവുന്നതാണ്...

[BROTHER WOOD](http://telegram.dog/brotherwoodfilmz)
[SeriesLand](http://telegram.dog/seriesland4u) 
...
ഞാൻ Brother Wood-ലെ Group Management Bot ആണ്... എന്നെ പ്രവർത്തിപ്പിക്കേണ്ട വിധം ആണ് താഴെ കൊടുത്തിട്ടുള്ളത്....
...
DONATE_STRING = """Hai...sir, 
കുറേ പണി പെട്ടാണ് [എന്റെ മാസ്റ്റർ](t.me/TheUnusualPsychopath) എന്നെ ഈ സ്ഥിതിയിൽ ആക്കിയത്, അതുകൊണ്ട് സഹായങ്ങൾ \
പ്രതീക്ഷിക്കുന്നു. സംഭാവനകൾ കൂമ്പാരമാകുമ്പോൾ പരിപാടി ഗംഭീരമാകും \
